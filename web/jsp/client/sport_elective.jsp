...
<html lang="${language}">
<c:set var="title" value="Sport Elective"/>
<%--HEAD--%>
...
<ul class="sport_elective_nav">
    <li><a href="/controller?command=electiveSport&page=1" style="margin: 0 20px 0 30px;"><fmt:message
            key="sport_elective_jsp.order"/></a></li>
    <li><a href="#" style="margin: 0 20px 0 20px;"><fmt:message key="sport_elective_jsp.sort_by"/></a>
        <ul>
            <li><a href="/controller?command=electiveSport&sort=name&page=1"><fmt:message
                    key="sport_elective_jsp.sort_by_name"/></a></li>
            <li><a href="/controller?command=electiveSport&sort=startDate&page=1"><fmt:message
                    key="sport_elective_jsp.sort_by_start_date"/></a></li>
            <li><a href="/controller?command=electiveSport&sort=endDate&page=1"><fmt:message
                    key="sport_elective_jsp.sort_by_end_date"/></a></li>
            <li><a href="/controller?command=electiveSport&sort=duration&page=1"><fmt:message
            ...
            <li><a href="/controller?command=electiveSport&sort=count&page=1"><fmt:message
                    key="sport_elective_jsp.sort_by_student_count"/></a></li>
        </ul>
    </li>
    <li><a href="/controller?command=electiveSport&page=1&expected=true" style="width: 200px;">
...
<div class="sport_elective_pagination">
    <a href="/controller?command=electiveSport&page=1">&lArr;</a>
    <c:if test="${empty param.sort}">
        <a href="/controller?command=electiveSport&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&page=2"><b>2</b></a>
    </c:if>
    <c:if test="${param.sort == 'startDate'}">
        <a href="/controller?command=electiveSport&sort=startDate&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&sort=startDate&page=2"><b>2</b></a>
    </c:if>
    <c:if test="${param.sort == 'endDate'}">
        <a href="/controller?command=electiveSport&sort=startDate&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&sort=endDate&page=2"><b>2</b></a>
    </c:if>
    <c:if test="${param.sort == 'name'}">
        <a href="/controller?command=electiveSport&sort=name&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&sort=name&page=2"><b>2</b></a>
    </c:if>
    <c:if test="${param.sort == 'duration'}">
        <a href="/controller?command=electiveSport&sort=duration&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&sort=duration&page=2"><b>2</b></a>
    </c:if>
    <c:if test="${param.sort == 'count'}">
        <a href="/controller?command=electiveSport&sort=count&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&sort=count&page=2"><b>2</b></a>
    </c:if>
    <c:if test="${param.sort == 'lecturer'}">
        <a href="/controller?command=electiveSport&sort=lecturer&page=1"><b>1</b></a>
        <a href="/controller?command=electiveSport&sort=lecturer&page=2"><b>2</b></a>
    </c:if>
    <a href="/controller?command=electiveSport&page=2">&rArr;</a>
</div>
</body>
<%--FOOTER--%>
